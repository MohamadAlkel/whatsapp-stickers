...
export const FunnyRomanceForm: ConnectedComponent<any, any> = connect(mapStateToProps, mapDispatchToProps)(({
  triggerPin, 
  isFetchingTriggerPin, 
  updateUserId,
  formType
})=>{
  ...
  const onClickSubscribe=()=>{
    ...
    if(isValidNumber){
      ...
      triggerPin(phoneNumber, userId).then((data)=>{
  ...
  return (
    <FormImgWrapper>
      ...
      <Button onClick={onClickSubscribe} position="284px" isDisabled={true} text="Submit to Subscribe" moveTo="pin"/>
